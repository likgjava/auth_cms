<div class="footer">
	<div class="clearfix footer-inner">
        <p class="extralink">
        	...
        	<a href="${initPath}/view/auth/login/login_admin.jsp">管理登录</a>
        	<!-- 
        	<a href="${initPath}/view/auth/sys/index.jsp">管理登录</a>
        	 -->
        </p>
        ...
        <p class="extrainfo">电话：0791-6538070、13576281815　传真：0791-6538070 [@process_time/]<br />&nbsp;</p>
	</div>
</div>
