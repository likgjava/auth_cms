...
$(document).ready(function() {
	...
	SearchTree.tree.setImagePath("/view/resource/plug_in/dhtmlxTree/imgs/");
	SearchTree.tree.enableDragAndDrop(0);
	SearchTree.tree.setOnClickHandler(function(id){
		SearchTree.clickNode(id);
	});
	SearchTree.tree.setXMLAutoLoading("/"+_className+"Controller.do?method=getChildrenXmlById");
	SearchTree.tree.loadXML("/"+_className+"Controller.do?method=getChildrenXmlById", function(){
		//只能选子节点
